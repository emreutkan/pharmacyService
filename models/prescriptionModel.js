...
const prescriptionSchema = new mongoose.Schema({
    tcId: { type: String, required: true }, // Patient ID (e.g., National ID)
    doctorId: { type: String, required: true }, // Doctor who created the prescription
    pharmacyId: { type: String }, // Pharmacy that submitted the prescription
    medicines: [
        {
